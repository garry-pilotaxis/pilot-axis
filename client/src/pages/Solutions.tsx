    ...
    <div className="flex flex-col min-h-screen text-white">
      ...
      <section className="pt-28 pb-20 px-4" style={{ borderBottom: `1px solid ${BD}` }}>
        <div className="container mx-auto max-w-4xl text-center">
          <p className="text-[10px] uppercase tracking-widest text-white/35 mb-4">What We Build</p>
          ...
          <div className="space-y-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl font-bold mb-4 text-white">1. AI Voice Agent</h2>
              ...
              >
                <div className="relative z-10 space-y-4">
                  <div className="p-4 w-3/4" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${BD}` }}>
                    <p className="text-xs text-white/40 mb-1">Caller</p>
                    <p className="text-sm text-white/80">"Hi, do you take walk-ins for a consultation?"</p>
                  </div>
                  <div className="p-4 w-3/4 ml-auto" style={{ background: PD, border: `1px solid ${PB}` }}>
                    ...
                    <p className="text-sm text-white/85">"We operate by appointment only to give you our full attention. I have a 2:30 PM slot open today. Would you like me to book that for you?"</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 aspect-square p-8 flex items-center justify-center" style={{ background: CB, border: `1px solid ${BD}` }}>
                <div className="w-full" style={{ border: `1px solid ${BD}` }}>
                  <div className="p-3 flex justify-between items-center" style={{ borderBottom: `1px solid ${BD}`, background: "rgba(255,255,255,0.03)" }}>
                    <span className="text-xs font-bold uppercase text-white/70">October 24</span>
                    <span className="text-xs text-white/40">Dr. Smith</span>
                  </div>
                    ...
                    {[
                      ...
                      <div
                        ...
                        style={{
                          ...
                          color: dark ? "#fff" : "rgba(255,255,255,0.40)",
                        }}
                      >
              ...
              <div className="order-1 md:order-2">
                ...
                <h2 className="text-3xl font-bold mb-4 text-white">2. Scheduling Engine</h2>
                <p className="text-white/55 mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl font-bold mb-4 text-white">3. CRM + Waitlist</h2>
                <p className="text-white/55 mb-6 leading-relaxed">
              ...
              <div className="aspect-square p-6 flex flex-col gap-2" style={{ background: CB, border: `1px solid ${BD}` }}>
                <div className="grid grid-cols-4 gap-2 text-[10px] uppercase font-bold text-white/35 pb-2" style={{ borderBottom: `1px solid ${BD}` }}>
                ...
                {[
                  ...
                  <div key={row.name} className="grid grid-cols-4 gap-2 text-xs py-2 items-center" style={{ borderBottom: `1px solid ${BD}` }}>
                    ...
                    <span className="text-white/50">{row.intent}</span>
                    <span className="px-2 py-1 text-center w-max text-[10px] font-bold" style={{
                      ...
                      color: row.hi ? PL : "rgba(255,255,255,0.45)",
                    }}>{row.priority}</span>
                    <span className="text-white/50">{row.status}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* "What we don't do" */}
      <section className="py-24 px-4" style={{ background: "rgba(255,255,255,0.02)", borderTop: `1px solid ${BD}` }}>
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-2xl font-bold tracking-tight mb-12 text-white">What we don't do.</h2>
