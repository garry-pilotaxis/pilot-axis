...
const BLOBS: Blob[] = [
  { color: "109,92,231",   size: 700, top: "-8%",  right: "-6%",  blur: 70,  opacity: 0.30 },
  { color: "79,70,229",    size: 550, bottom: "5%", left: "-8%",   blur: 90,  opacity: 0.18 },
  { color: "139,92,246",   size: 420, top: "35%",   left: "30%",   blur: 110, opacity: 0.10 },
  { color: "45,212,191",   size: 380, bottom: "20%",right: "10%",  blur: 100, opacity: 0.07 },
  { color: "99,102,241",   size: 320, top: "60%",   left: "60%",   blur: 80,  opacity: 0.09 },
];
